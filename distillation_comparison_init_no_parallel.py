...
STUDENT_DIR = os.path.join(result_dir_root, 'student_v1')

BASE_COMMAND = (
    "python student_trainer.py distill2d"
    " --teacher_ckpt gsplat_teachers/bicycle_4/ckpts/ckpt_29999_rank0.pt"
    " --data_factor 4"
    f" --data_dir {DATA_DIR}/{DATASET_NAME}"
    " --disable_viewer"
    " --strategy.grow_grad2d 0.0009"
...
def main():
    ...
    # target_sh_coeffs_mults = 1.5

    sh_coeffs_mults = [1,1.5,2]
        ...
        if distill_sh_lambda > 0 and distill_depth_lambda > 0:
            for gradient_key in key_for_gradient:
                ...
                for sh_mult in sh_coeffs_mults:
                    sh_mult = sh_mult / distill_sh_lambda
        ...
        # Case 3: Only depth lambda > 0
            ...
            for gradient_key in key_for_gradient:
                ...
                for depth_mult in sh_coeffs_mults:
                    depth_mult = depth_mult / distill_depth_lambda * 0.25
                    for grow_grad2d in grow_grad2ds:
                        cmd = base_command
                        cmd += f' --strategy.depths_mult {depth_mult}'
                        cmd += f' --strategy.key_for_gradient {gradient_key}'
