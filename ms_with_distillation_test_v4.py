...
STUDENT_DIR = os.path.join(result_dir_root, 'reducing_v6')
...
def generate_commands():
    ...
    target_sampling_pairs = [(0.6, 0.9), (0.45, 0.75), (0.3, 0.6), (0.45, 0.6), (0.6, 0.75), (0.75, 0.9)]
    
    # Each combination is a dictionary of lambdas.
    combinations = [
        # {"distill_sh_lambda": 0.25, "distill_colors_lambda": 0, "distill_depth_lambda": 0, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0, "distill_colors_lambda": 0.25, "distill_depth_lambda": 0, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0, "distill_colors_lambda": 0, "distill_depth_lambda": 0.25, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0, "distill_colors_lambda": 0, "distill_depth_lambda": 0, "distill_xyzs_lambda": 0.25, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0, "distill_colors_lambda": 0, "distill_depth_lambda": 0, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0.25},
        # all 0.25
        ...
        # {"distill_sh_lambda": 0.25, "distill_colors_lambda": 0.25, "distill_depth_lambda": 0, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0.25, "distill_colors_lambda": 0, "distill_depth_lambda": 0.25, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
        # {"distill_sh_lambda": 0, "distill_colors_lambda": 0.25, "distill_depth_lambda": 0.25, "distill_xyzs_lambda": 0, "distill_quats_lambda": 0},
    ]
                        ...
                        for key in key_for_gradients:
                            ...
                            for sh_mult in sh_coeffs_mults:
                                for grow_base in grow_grad2ds:
                                    ...
                                    output_dir_name = (
                                        f"{DATASET_NAME}_{DATA_FACTOR}_SMALL"
    ...
    # Define lists of options.
    use_blur_splits = [True]
    use_novel_views = [True, False]
    # Target sampling is given as a pair (start, target). We format it as "start-target".
    target_sampling_pairs = [(0.125, 0.25), (0.25, 0.5)]
    ...
    use_novel_views = [True, False]
    # Target sampling is given as a pair (start, target). We format it as "start-target".
    target_sampling_pairs = [(0.05, 0.1), (0.4, 0.5)]
    
    # Each combination is a dictionary of lambdas.
    combinations = [
        {"distill_sh_lambda": 0, "distill_colors_lambda": 0.25, "distill_depth_lambda": 0.25, "distill_xyzs_lambda": 0.25, "distill_quats_lambda": 0.25},
        {"distill_sh_lambda": 0, "distill_colors_lambda": 0.25, "distill_depth_lambda": 0.25, "distill_xyzs_lambda": 0,   "distill_quats_lambda": 0},
        {"distill_sh_lambda": 0, "distill_colors_lambda": 0,   "distill_depth_lambda": 0,   "distill_xyzs_lambda": 0,   "distill_quats_lambda": 0},
    ]
    key_for_gradients = ['depths_and_sh', 'means2d']
    # Even if there is only one value here, we include it to be explicit.
    sh_coeffs_mults = [20]
    grow_grad2ds = [0.0002]
    # start_sampling_ratio: float = 0.75
