...
class Config:
    ...
    eval_steps: List[int] = field(default_factory=lambda: [7_000, 14999, 15001, 19999, 20001, 30_000])
...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            # sh schedule
            sh_degree_to_use = max(0, min((step - cfg.simp_iteration1) // cfg.sh_degree_interval, cfg.sh_degree))
