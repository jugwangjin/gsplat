...
from gsplat.strategy import DefaultStrategy, MCMCStrategy, ImageAwareStrategy
...
class Config:
    ...
    strategy: Union[DefaultStrategy, MCMCStrategy, ImageAwareStrategy] = field(
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            renders, alphas, info = self.rasterize_splats(
                ...
                masks=masks,
                gt_image=pixels[..., :3], # assert gt_image is 3d
            )
            ...
            if step > 2000:
                info.update({"draw_plot": True})
            else:
                info.update({"draw_plot": False})
...
if __name__ == "__main__":
    ...
    configs = {
        ...
        "image_aware": (
            "Gaussian splatting training using image-aware strategy.",
            Config(
                strategy=ImageAwareStrategy(verbose=True),
            ),
        ),
    }
