...
from utils import AppearanceOptModule, CameraOptModule, knn, rgb_to_sh, set_random_seed, visualize_id_maps, depth_reinitialization, simplification, simplification_from_mesh_simp_v2
        ...
        for step in pbar:
            ...
            if isinstance(self.cfg.strategy, MSDStrategy):
                ...
                if step in cfg.depth_reinit_iters and step < self.cfg.strategy.refine_stop_iter and n_gaussians > cfg.num_depth:
                    ...
                    self.splats, self.optimizers = simplification_from_mesh_simp_v2(
                        trainset = self.trainset,
                        runner = self,
                        parser = self.parser,
                        cfg = self.cfg,
