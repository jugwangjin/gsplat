...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            # sh schedule
            sh_degree_to_use = max(0, min((step - cfg.simplification_start_step) // cfg.sh_degree_interval, cfg.sh_degree))
            ...
            if isinstance(self.cfg.strategy, MSDStrategy):
                ...
                if False and step < self.cfg.strategy.refine_stop_iter and step % cfg.subsampling_interval == 0:
                    ...
                    self.splats, self.optimizers = simplification_from_mesh_simp(
                        ...
                        parser = self.parser,
                        cfg = self.cfg,
                        sampling_factor = cfg.subsampling_ratio,
                        keep_sh0 = True,
                        keep_feats = True,
                        batch_size=cfg.batch_size,
                        sparse_grad=cfg.sparse_grad,
                ...
                if step in cfg.depth_reinit_iters and step < self.cfg.strategy.refine_stop_iter:
                    ...
                    print("Number of Gaussians before depth reinitialization: ", n_gaussians)
                    print("Number of Gaussians after depth reinitialization: ", len(self.splats["means"]))
