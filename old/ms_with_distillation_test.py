...
BASE_COMMAND = (
    "python student_trainer_w_ms.py distill2d"
...
def generate_commands():
    ...
    key_for_gradient = ['depths_and_sh', 'rendered_sh_coeffs']
    ...
    # Update sampling factors for ms_trainer commands to [0.5, 0.25, 0.1].
    if not os.path.exists('/Bean/log/gwangjin/2025/kdgs/ms/bicycle_depth_reinit_sampling_0.25/ckpts/ckpt_29999_rank0.pt'):
    ...
    for use_blur_split in use_blur_splits:
        for use_novel_view in use_novel_views:
            ...
            for target_sampling in [0.025, 0.05, 0.1]:
                            ...
                            for sh_mult in sh_coeffs_mults:
                                ...
                                for grow_grad2d in grow_grad2ds:
                                    ...
                                    output_dir_name = (
                                        ...
                                        f'_blur{use_blur_split}_target{target_sampling}'
                                    )
