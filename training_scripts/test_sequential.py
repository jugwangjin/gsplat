...
result_dir_root = '/Bean/log/gwangjin/2025/kdgs/students_sequential'
DATA_FACTOR = 4


# Directories for teacher and student.
FULL_TEACHER_CKPT = '/Bean/log/gwangjin/2025/kdgs/teachers/bicycle_4_small/ckpts/ckpt_29999_rank0.pt'
FULL_TEACHER_DIR = os.path.dirname(os.path.dirname(FULL_TEACHER_CKPT))
STUDENT_DIR = os.path.join(result_dir_root, 'sequential')

max_steps = 10000

FULL_BASE_COMMAND = (
    "python student_sequential.py distill2d"
                                ...
                                for grow_base in grow_grad2ds:
                                    for kt in kt_steps:
                                        ...
                                        output_dir_name = (
                                            ...
                                            f"_start{start_sampling_ratio}_target{target_sampling_ratio}_kt{kt}"
                                            f"_{distill_function}"
                                            f"_{key}"
                                        )
