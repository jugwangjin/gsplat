                            ...
                            for sh_mult in sh_coeffs_mults:
                                for grow_base in grow_grad2ds:
                                    ...
                                    output_dir_name = (
                                        ...
                                        f"_sh{d_sh}_colors{d_colors}_depth{d_depth}_xyzs{d_xyzs}_quats{d_quats}_scales{d_scales}_opacities{d_opacities}_cycles{num_cycles}"
                                        f"_{key}"
                                    )
                                    if sh_coeffs_mult_val:
                        ...
                        for key in key_for_gradients:
                            ...
                            for sh_mult in sh_coeffs_mults:
                                for grow_base in grow_grad2ds:
                                    ...
                                    target_sampling_ratio = target_sampling_ratio ** num_cycles
                                    start_sampling_ratio = target_sampling_ratio * 0.875
                                    ...
                                    output_dir_name = (
                                        ...
                                        f"_blur{use_blur_split}_novel{use_novel_view}_densify{use_densification}"
                                        f"_start{start_sampling_ratio}_target{target_sampling_ratio}"
                                        f"_sh{d_sh}_colors{d_colors}_depth{d_depth}_xyzs{d_xyzs}_quats{d_quats}_scales{d_scales}_opacities{d_opacities}_cycles1"
                                        f"_{key}"
                                    )
                                    if sh_coeffs_mult_val:
                                        output_dir_name += f"_shmult{sh_coeffs_mult_val}"
